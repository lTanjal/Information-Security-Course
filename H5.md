...
I connected with my VR machine through ssh, created a file named authorized_keys in home dir .ssh folder using **nano ~/.ssh/authorized_keys**
and pasted my pub there from my host.

I change read and write mode of authorized_keys to -rw-------  with 
**chmod 600 ~/.ssh/authorized_keys** that only VM user can read/write it.

Then I used
**ssh -i $env:USERPROFILE\.ssh\my_private_keys myUserName@VM_IP** 
